...
import com.kuncham.kyetees.adapter.GridviewDetailsAdapter;
import com.kuncham.kyetees.modelclasses.Bean;
...
public class ProductDetails extends AppCompatActivity implements BaseSliderView.OnSliderClickListener{
    ...
    private int[] IMAGEgrid = {R.drawable.item1, R.drawable.item2, R.drawable.item3, R.drawable.item4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("1", R.drawable.item1);
        file_maps.put("2",R.drawable.item2);
        file_maps.put("3",R.drawable.item3);
